![Panda Logo](https://cdn.rawgit.com/DHedgecock/vscode-panda-extended/master/assets/cover.jpg)
...
---
![Main ScreenShot](https://cdn.rawgit.com/DHedgecock/vscode-panda-extended/master/assets/editor.jpg)
...
1. Go to `Extensions`
2. Search for `Panda Extended` and install it.
3. Go to `Color Themes` and choose `Panda Extended` as the color theme or `CMD + Shift + P` and enter Command `> color theme` and choose `Panda Extended`.
...
* This repo if it's about color changes, first read [Color Semantics](https://github.com/DHedgecock/vscode-panda-extended/blob/master/Color%20Semantics.md) and Change `themes` files.
...
<!--<h1 align="center">
  ...
  <img width="500" src="https://cdn.rawgit.com/DHedgecock/vscode-panda-extended/master/assets/cover.jpg" alt="Panda"/>
</h1>
